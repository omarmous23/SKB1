...
public class SkillBuilder1Test extends OutputTest {
    ...
    public void testMain_1() {
        ...
        String expected_match = "Well Jean Claude, the spice value resulted in 1\\.4815\n" +
                "And the converted value is 1\\.48";
    ...
    public void testMain_2() {
        ...
        String expected = "You're Jane's friend!\n" +
                "\"What's your name?\"\n" +
                "Enter a floating-point number:\n" +
                "Well Jean Claude, the spice value resulted in 1.4113\n" +
                "And the converted value is 1.41";
        String expected_match = "Well Jean Claude, the spice value resulted in 1\\.4113\n" +
